...
use crate::sync::object::JsonObject;
...
mod tests {
    ...
    #[case::f64_exp(Box::new(|w: &mut AS| w.write_f64_value(1.234e10)), "12340000000")]
    #[case::f64_exp_20(Box::new(|w: &mut AS| w.write_f64_value(1.234e20)), "123400000000000000000")]
    #[case::f64_neg_exp(Box::new(|w: &mut AS| w.write_f64_value(1.234e-10)), "0.0000000001234")]
    ...
    #[case::f32_exp(Box::new(|w: &mut AS| w.write_f32_value(1.234e10)), "12340000000")]
    #[case::f32_exp_20(Box::new(|w: &mut AS| w.write_f32_value(1.234e20)), "123400000000000000000")]
    #[case::f32_neg_exp(Box::new(|w: &mut AS| w.write_f32_value(1.234e-10)), "0.0000000001234")]
