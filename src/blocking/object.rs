...
mod tests {
    ...
    #[case::f64(Box::new(|w: &mut OS| w.write_f64_value("a", 2.0)), "2.0")]
    #[case::f64_exp(Box::new(|w: &mut OS| w.write_f64_value("a", 1.234e10)), "12340000000.0")]
    #[case::f64_exp_20(Box::new(|w: &mut OS| w.write_f64_value("a", 1.234e20)), "1.234e20")]
    #[case::f64_neg_exp(Box::new(|w: &mut OS| w.write_f64_value("a", 1.234e-10)), "1.234e-10")]
    ...
    #[case::f32(Box::new(|w: &mut OS| w.write_f32_value("a", 2.0)), "2.0")]
    #[case::f32_exp(Box::new(|w: &mut OS| w.write_f32_value("a", 1.234e10)), "12340000000.0")]
    #[case::f32_exp_20(Box::new(|w: &mut OS| w.write_f32_value("a", 1.234e20)), "1.234e20")]
    #[case::f32_neg_exp(Box::new(|w: &mut OS| w.write_f32_value("a", 1.234e-10)), "1.234e-10")]
